...
//Inicializamos una variable menu que vamos a usar para construir el html y almacenar los datos de la compra del usuario
let menu =[]
...
//Importamos los datos del menu de un archivo .json local y dentro de las promesas del fetch creamos el resto del html inicial de manera asincronica
fetch('menu.json')
.then ((respuesta) => respuesta.json())
.then ((data) => {
    data.forEach((elemento) =>{
        menu.push(elemento) //Cargamos los objetos del Json en el array menu
    })
...
//Funcion enviar formulario: carga los datos de la compra en memoria y aplica las funciones "aplicar descuento" y "mostrar compra"
